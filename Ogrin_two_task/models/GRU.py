...
class Output_net_1(nn.Module):
    def __init__(self,input_size,args):
        ...
        # linear
        self.hidden_dim = args.hidden_layer
        self.out_class_1 = args.out_class_1
        self.input2hidden = nn.Linear(input_size, self.hidden_dim * 2)
        self.hidden2hidden = nn.Linear(self.hidden_dim * 2, self.hidden_dim)
        self.hidden2label = nn.Linear(self.hidden_dim, self.out_class_1)
...
'''
class Utterance_net_Ind(nn.Module):
    def __init__(self, input_size, hidden_size, output_size, args):
        super(Utterance_net_Ind, self).__init__()
        self.hidden_dim = args.hidden_layer
        self.num_layers = args.dia_layers
        #  dropout
        self.dropout = nn.Dropout(args.dropout)
...
class Utterance_net_ALL(nn.Module):
    def __init__(self, input_size, hidden_size, output_size, args):
        super(Utterance_net_ALL, self).__init__()
        self.hidden_dim = args.hidden_layer
        self.num_layers = args.dia_layers
        #  dropout
        self.dropout = nn.Dropout(args.dropout)

...
with open('../MELD_Feature/Train_data_Multi_Speaker.pickle', 'rb') as file:
...
parser.add_argument('--gru_insize', type=int, default=1611)
...
def Train(epoch):
    ...
    for batch_idx, (data_1_1, data_1_2, data_1_3, data_2_1, data_2_2, data_2_3, target) in enumerate(
            train_loader):
        if args.cuda:
            data_1_1, data_1_2, data_1_3, data_2_1, data_2_2, data_2_3, target = data_1_1.cuda(), data_1_2.cuda(), data_1_3.cuda(), data_2_1.cuda(), data_2_2.cuda(), data_2_3.cuda(), target.cuda()
        # data (batch_size, step, 88)
        # target (batch_size, 1)
        data_1_1, data_1_2, data_1_3, data_2_1, data_2_2, data_2_3, target = Variable(data_1_1), Variable(
        ...
        # opensmile
        #data_1_1 = data_1_1.squeeze(1)
        #data_1_2 = data_1_2.squeeze(1)
        #data_1_3 = data_1_3.squeeze(1)
        # Bert
        #data_2_1 = data_2_1.squeeze(1)
        #data_2_2 = data_2_2.squeeze(1)
        #data_2_3 = data_2_3.squeeze(1)
        ...
        dia_out_a, dia_hid_a = dia_net_a(data_1_1)
        dia_out_b, dia_hid_b = dia_net_b(data_1_2)

        dia_out_all, _ = dia_net_all(data_1_3)
...
def Test():
    ...
    with torch.no_grad():
        ...
        print(CM_test)
        print("########################################")
    # return accuracy_f1_1, accuracy_recall_1, label_pre_1, label_true_1
...
train_loader, test_loader,input_test_data_id, input_test_label_org, test_len = Get_data(
    data, args)

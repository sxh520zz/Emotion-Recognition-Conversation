...
parser.add_argument('--Dia_insize', type=int, default=1280)
...
def Train(epoch):
    ...
    for batch_idx, (data_1,data_2,data_3,data_1_1,data_2_1,data_3_1,target,target_1,target_2) in enumerate(train_loader):
        ...
        dia_out_all_concate, dia_out_all = dia_net_all(data_3_1)
        speaker_1 = dia_out_all.index_select(1, target_1)
        speaker_2 = dia_out_all.index_select(1, target_2)

        Gru_1 = torch.cat((data_1_1,speaker_1), 2)
        Gru_2 = torch.cat((data_2_1,speaker_2), 2)

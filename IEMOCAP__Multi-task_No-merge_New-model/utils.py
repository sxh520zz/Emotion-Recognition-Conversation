...
class subDataset(Dataset.Dataset):
    def __init__(self,Data_1,Data_2,Label,Label_1,Tag_1,Tag_2):
        self.Data_1 = Data_1
        self.Data_2 = Data_2
        self.Label = Label
    ...
    def __getitem__(self, item):
        ...
        tag_1 = torch.IntTensor(np.array(self.Tag_1[item]))
        tag_2 = torch.IntTensor(np.array(self.Tag_2[item]))

        return data_1_S,data_1_I,data_1_II,data_2_S,data_2_I,data_2_II,label,label_1,tag_1,tag_2
...
def Feature(args,data):
    ...
    input_label_1 = []
    for i in range(len(data)):
        input_label_1.append(data[i]['Self_Emotion_Change'])
    ...
    return input_train_data_trad,input_train_data_tran,input_label,input_label_1,input_label_self_Emotion_Change,input_label_Inter_Emotion_Change,input_data_id,input_orgin_label
...
def Get_data(data,train,test,args):
    ...
    print(len(test_data))
    input_train_data_trad,input_train_data_tran,input_train_label,input_train_label_1,input_train_tag_1,input_train_tag_2,_,_ = Feature(args,train_data)
    input_test_data_trad,input_test_data_tran,input_test_label,input_test_label_1,input_test_tag_1,input_test_tag_2,input_test_data_id,input_test_label_org = Feature(args,test_data)
    ...
    train_dataset = subDataset(input_train_data_trad,input_train_data_tran,label,label_1,input_train_tag_1,input_train_tag_2)
    test_dataset = subDataset(input_test_data_trad,input_test_data_tran,label_test,label_test_1,input_test_tag_1,input_test_tag_2)
